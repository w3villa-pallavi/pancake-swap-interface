...
import { Box, Flex, AddIcon, AutoRenewIcon, LogoIcon } from "@pancakeswap-libs/uikit";
...
export const Anchors: React.FC = () => {
  return (
    <>
      ...
      <Box>
        <Button as="a" href="https://yffii.finance" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://yffii.finance" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
