import { Price, TokenAmount, InsufficientReservesError, InsufficientInputAmountError, Token } from '@pancakeswap-libs/sdk'
...
export default class Pair {
  ...
  public constructor(tokenAmountA: TokenAmount, tokenAmountB: TokenAmount) {
    ...
    this.liquidityToken = new Token(
      ...
      Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token, parseInt(process.env.REACT_APP_CHAIN_ID ?? '56')),
      18,
      'UNI-V2',
      'Uniswap V2'
    )
